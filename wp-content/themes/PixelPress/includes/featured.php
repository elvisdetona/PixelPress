...
<div class="controls-container">
		<ul class="slides">
			...
			<?php
				...
				$bgcolor = get_post_meta( get_the_ID(), 'background_color', true );
				$bgimage = get_post_meta( get_the_ID(), 'background_image', true );
				$bgrepeat = get_post_meta( get_the_ID(), 'background_repeat', true );

			?>

			<li class="slide">
	    		<div class="slide-content-container" style="background-color: <?php echo esc_attr($bgcolor); ?>; background-image:url(<?php echo esc_attr($bgimage); ?>); background-repeat:<?php echo esc_attr($bgrepeat); ?>">
    	    			...
    	    			<div class="entry">
	        				...
	        				<?php
	    	    				if ( $slidertype == 'default' && !$has_embed ) {
		        					woo_image( 'width=911&class=slide-image full&link=img&height=' . $settings['featured_height'] );
		        				} else {
		        					echo $has_embed;
		        				}
	        				?>
